    ...
    static class HttpRequest
    {
        ...
        public static async Task<HttpResponseMessage> http_get(string base_url, string access_token, string url_command)
        {
            ...
            using (HttpClient client = new HttpClient(handler, true))
            {
                ...
                response = await client.GetAsync(base_url + url_command);
            }
        ...
        public static async Task<dynamic> get_get_response(string base_url, string access_token, string url_command)
        {
        ...
        public static async Task<HttpResponseMessage> http_put(string base_url, string access_token, string url_command, HttpContent content)
        {
            ...
            using (HttpClient client = new HttpClient(handler, true))
            {
                ...
                response = await client.PutAsync(base_url + url_command, content);
            }
        ...
        public static async Task<dynamic> get_put_response(string base_url, string access_token, string url_command)
        {
            string return_val = string.Empty;
        ...
        public static async Task<HttpResponseMessage> http_post(string base_url, string access_token, string url_command, HttpContent content)
        {
            HttpResponseMessage response = null;
            ...
            using (HttpClient client = new HttpClient(handler, true))
            {
                ...
                response = await client.PostAsync(base_url + url_command, content);
            }
        ...
        public static async Task<dynamic> get_post_response(string base_url, string access_token, string url_command)
        {
            string return_val = string.Empty;

            using (HttpResponseMessage response = await http_post(base_url, access_token, url_command, null))
            {
                return_val = await response.Content.ReadAsStringAsync();
                Console.WriteLine("String from response: " + return_val);
